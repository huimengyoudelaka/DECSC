...
def fastSoftThrs(x, lmbda, ct):
    # return 0.5*x + 0.5*soft_threshold(x, lmbda)
    return soft_threshold(x, lmbda)
    # return 0.5*x + 0.5*x*lmbda
    # return x + ct*(x-soft_threshold(x, lmbda))
